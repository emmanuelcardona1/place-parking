function ingresar() {
    ...
    let verificacionusuario1 = "manolo1";
    let verificacioncontraseña1 = "123456" ;
    let verificacionusuario2 = "admin";
    let verificacioncontraseña2 = "admin1234" ;

    // Verificación de usuario y contraseña
    if (usuario === verificacionusuario1 && contraseña === verificacioncontraseña1 || usuario === verificacionusuario2 && contraseña === verificacioncontraseña2) {
